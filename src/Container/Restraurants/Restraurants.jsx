import RestraurantsCard from '../../components/restraurantCard/Restraurant'
import styles from './Restraurants.module.css'
...
const Restraurant = () => {
    ...
    const onRestaurantFilter = (restaurantData) => {
        if (
            restaurantData.name.toLowerCase().includes(searchKey.toLowerCase().trim()) && Number(restaurantData.rating) >= Number(rating)
            ){
                return true
            } else {
                return false
    ...
    return (
        <>
            <div className={styles["box-container"]}>
                <input onChange={onSearchBoxChange}
                type="text" placeholder='Search Restraurants...' />
                <div>
                    Minimum Rating : <input 
                    onChange={onRatingBoxChange}
                    type="number" />
                </div>
            </div>
            <div className={styles.container}>
                {
                    restaurantList.filter(onRestaurantFilter).map((restaurantData) => {
                        //console.log(restraurantData)
                        // return <RestraurantsCard data={restraurantData}/>
                        return <RestraurantsCard key={restaurantData._id} {...restaurantData}/>
                    })
                }
